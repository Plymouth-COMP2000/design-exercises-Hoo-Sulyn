...
public class Guest_Edit_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuNav.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Profile.this, Guest_Menu_Page.class)));
        reservationNav.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Profile.this, Guest_Reservation_Page.class)));
        reservationHistoryNav.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Profile.this, Reservation_History.class)));
        profileNav.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Profile.this, Profile_Settings.class)));
        notificationSettingsNav.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Profile.this, Guest_Notification_Settings_Page.class)));

        logoutNav.setOnClickListener(v -> {
            // Create a Dialog
            Dialog dialog = new Dialog(Guest_Edit_Profile.this);
            ...
            confirmBtn.setOnClickListener(view -> {
                startActivity(new Intent(Guest_Edit_Profile.this, MainActivity.class));
        ...
        back_button.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Profile.this, Profile_Settings.class)));
    }
}