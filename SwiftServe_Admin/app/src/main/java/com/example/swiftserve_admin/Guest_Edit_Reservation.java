...
public class Guest_Edit_Reservation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuNav.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Reservation.this, Guest_Menu_Page.class)));
        reservationNav.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Reservation.this, Guest_Reservation_Page.class)));
        reservationHistoryNav.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Reservation.this, Reservation_History.class)));
        profileNav.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Reservation.this, Guest_Profile_Settings.class)));
        notificationSettingsNav.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Reservation.this, Guest_Notification_Settings_Page.class)));

        logoutNav.setOnClickListener(v -> {
            // Create a Dialog
            Dialog dialog = new Dialog(Guest_Edit_Reservation.this);
            ...
            confirmBtn.setOnClickListener(view -> {
                startActivity(new Intent(Guest_Edit_Reservation.this, MainActivity.class));
        ...
        // SAVE CHANGES
        // -----------------------
        MaterialButton save_changes = findViewById(R.id.save_changes_button);
        save_changes.setOnClickListener(v -> {
            // Show a quick popup message
            Toast.makeText(Guest_Edit_Reservation.this, "Changes have been saved", Toast.LENGTH_SHORT).show();
            finish();
        });
        ...
        footerMenu.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Reservation.this, Guest_Menu_Page.class)));
        footerReservation.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Reservation.this, Guest_Reservation_Page.class)));
        footerHistory.setOnClickListener(v -> startActivity(new Intent(Guest_Edit_Reservation.this, Reservation_History.class)));
    }
