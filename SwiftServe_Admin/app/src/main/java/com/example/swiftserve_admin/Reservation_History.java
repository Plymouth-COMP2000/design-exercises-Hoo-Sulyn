...
public class Reservation_History extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuNav.setOnClickListener(v -> startActivity(new Intent(Reservation_History.this, Guest_Menu_Page.class)));
        reservationNav.setOnClickListener(v -> startActivity(new Intent(Reservation_History.this, Guest_Reservation_Page.class)));
        reservationHistoryNav.setOnClickListener(v -> startActivity(new Intent(Reservation_History.this, Reservation_History.class)));
        profileNav.setOnClickListener(v -> startActivity(new Intent(Reservation_History.this, Profile_Settings.class)));
        notificationSettingsNav.setOnClickListener(v -> startActivity(new Intent(Reservation_History.this, Guest_Notification_Settings_Page.class)));

        logoutNav.setOnClickListener(v -> {
            // Create a Dialog
            Dialog dialog = new Dialog(Reservation_History.this);
            ...
            confirmBtn.setOnClickListener(view -> {
                startActivity(new Intent(Reservation_History.this, MainActivity.class));
        ...
        view_details.setOnClickListener(v -> startActivity(new Intent(Reservation_History.this, Guest_Reservation_Receipt.class)));
        ...
        footerMenu.setOnClickListener(v -> startActivity(new Intent(Reservation_History.this, Guest_Menu_Page.class)));
        footerReservation.setOnClickListener(v -> startActivity(new Intent(Reservation_History.this, Guest_Reservation_Page.class)));
        footerHistory.setOnClickListener(v -> startActivity(new Intent(Reservation_History.this, Reservation_History.class)));
    }
}