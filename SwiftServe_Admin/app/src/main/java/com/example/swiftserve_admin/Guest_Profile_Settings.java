...
public class Guest_Profile_Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuNav.setOnClickListener(v -> startActivity(new Intent(Guest_Profile_Settings.this, Guest_Menu_Page.class)));
        reservationNav.setOnClickListener(v -> startActivity(new Intent(Guest_Profile_Settings.this, Guest_Reservation_Page.class)));
        reservationHistoryNav.setOnClickListener(v -> startActivity(new Intent(Guest_Profile_Settings.this, Reservation_History.class)));
        profileNav.setOnClickListener(v -> startActivity(new Intent(Guest_Profile_Settings.this, Guest_Profile_Settings.class)));
        notificationSettingsNav.setOnClickListener(v -> startActivity(new Intent(Guest_Profile_Settings.this, Guest_Notification_Settings_Page.class)));

        logoutNav.setOnClickListener(v -> {
            // Create a Dialog
            Dialog dialog = new Dialog(Guest_Profile_Settings.this);
            ...
            confirmBtn.setOnClickListener(view -> {
                startActivity(new Intent(Guest_Profile_Settings.this, MainActivity.class));
        ...
        // SETTINGS
        // -----------------------
        LinearLayout notification_settings_button = findViewById(R.id.notification_settings_button);
        LinearLayout edit_profile_button = findViewById(R.id.edit_profile_button);

        notification_settings_button.setOnClickListener(v -> startActivity(new Intent(Guest_Profile_Settings.this, Guest_Notification_Settings_Page.class)));
        edit_profile_button.setOnClickListener(v -> startActivity(new Intent(Guest_Profile_Settings.this, Guest_Edit_Profile.class)));
    }
}